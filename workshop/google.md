...
1. Please copy the text below the line into a new mail **from whichever email address you have on file with Google**.
2. Please replace `<< PARTICIPANT TO INSERT USERNAME, ACCOUNT ID, PHONE NUMBER OR OTHER APPROPRIATE IDENTIFIERS HERE >>` with any identifying information you have with this company, including your account e-mail address, phone number and/or any other identifiers they may have for you such as user account identifiers.
4. Please replace` << PARTICIPANT FULL NAME >>` with your name on the account that they know you by.
5. Make any other changes to the mail if you wish.
6. Please send the edited mail to `data-access-requests@google.com` with the subject line “GDPR Data Access Request for Google”.
7. Please monitor the account email address regularly for acknowledgements, questions or updates, and contact us with any updates or questions. 

### Subject Access Request Template Message

```
Dear Data Protection Officer for Google,
...
I am aware of Google Takeout. This request goes beyond the data that Takeout makes available, therefore please process this request manually rather than referring me to use Takeout.
...
```
---
if you have any questions, please contact **workshop@hestia.ai**.
