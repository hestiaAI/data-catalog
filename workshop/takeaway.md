...
4. Fill the request with this template and don't forget to sign it at the end.
5. You should receive data by email within 30 days.

## Subject Access Request Template
```
Dear Data Protection Officer for Takeaway/Just Eat,

This message is a transparency request under the GDPR including a subject access request, a portability request, and other specific provisions. Please note that it is not legal to require data subjects to use an in-house form*.
