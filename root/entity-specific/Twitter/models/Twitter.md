...
| $ | RootNode | N/A | None |
| $[*] | dict | N/A | None |
| $[*].ad | dict | N/A | Promoted Tweets the account has engaged with and any associated metadata. |
...
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.displayLocation | str | https://schema.org/location | Location where the ad was engaged with on Twitter. |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo | dict | N/A | Information about the associated tweet such as unique identifier, text, URLs and media when applicable. |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.tweetId | str | https://www.wikidata.org/wiki/Property:P5933 | identifier of a status on Twitter (tweet number) |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.tweetText | str | https://schema.org/Text | text content of the tweet |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.urls | list | N/A | list of URLs |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.urls[*] | str | https://schema.org/url | None |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.mediaUrls | list | N/A | None |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTweetInfo.mediaUrls[*] | str | https://schema.org/url | None |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.advertiserInfo | dict | N/A | Advertiser name and screen name. |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.advertiserInfo.advertiserName | str | https://schema.org/name | Official name of the advertiser |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.advertiserInfo.screenName | str | https://www.wikidata.org/wiki/Q53311579 | Twitter handle of the advertiser (beginning with ?@?) |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.matchedTargetingCriteria | list | N/A | List of targeting criteria that were used to run the campaign. |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.matchedTargetingCriteria[*] | dict | N/A | Targeting criteria that were used to run the campaign, consisting in a Type and a Value (see below) |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.matchedTargetingCriteria[*].targetingType | str | https://schema.org/text | Criteria used to segment the market among Twitter users |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.matchedTargetingCriteria[*].targetingValue | str | https://schema.org/text | Value of the critera above |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.impressionTime | str | https://schema.org/DateTime | Date and time when the ad was viewed. |
| $[*].ad.adsUserData.adEngagements.engagements[*].impressionAttributes.promotedTrendInfo | dict | N/A | None |
...
| $[*].ad.adsUserData.adImpressions.impressions[*].deviceInfo.deviceId | str | https://schema.org/identifier | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].displayLocation | str | https://schema.org/location | Location where the ad was viewed on Twitter. |
| $[*].ad.adsUserData.adImpressions.impressions[*].advertiserInfo | dict | N/A | Advertiser name and screen name. |
| $[*].ad.adsUserData.adImpressions.impressions[*].advertiserInfo.advertiserName | str | https://schema.org/name | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].advertiserInfo.screenName | str | https://www.wikidata.org/wiki/Q53311579 | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].matchedTargetingCriteria | list | N/A | Targeting criteria that were used to run the campaign. |
| $[*].ad.adsUserData.adImpressions.impressions[*].matchedTargetingCriteria[*] | dict | N/A | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].matchedTargetingCriteria[*].targetingType | str | https://schema.org/identifier | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].matchedTargetingCriteria[*].targetingValue | str | https://schema.org/text | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].impressionTime | str | https://schema.org/DateTime | Date and time when the ad was viewed. |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo | dict | N/A | Information about the associated tweet such as unique identifier, text, URLs and media when applicable. |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.tweetId | str | https://www.wikidata.org/wiki/Property:P5933 | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.tweetText | str | https://schema.org/text | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.urls | list | N/A | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.urls[*] | str | https://schema.org/url | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.mediaUrls | list | N/A | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTweetInfo.mediaUrls[*] | str | https://schema.org/url | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTrendInfo | dict | N/A | None |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTrendInfo.trendId | str | https://schema.org/identifier | numerical identifier for the promoted trend |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTrendInfo.name | str | https://www.wikidata.org/wiki/Q278485 | Hashtag of the promoted trend |
| $[*].ad.adsUserData.adImpressions.impressions[*].promotedTrendInfo.description | str | https://schema.org/text | Promotional text |
